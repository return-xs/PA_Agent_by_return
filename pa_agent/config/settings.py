...
DataSourceKind = Literal["mt5", "tradingview", "akshare", "eastmoney", "tushare", "yfinance", "csv", "binance"]
...
class GeneralSettings(BaseModel):
    ...
    csv_timeframe: str = ""
    #: 币安数据源：交易市场（futures=U本位合约, spot=现货）
    binance_market: Literal["futures", "spot"] = "futures"
